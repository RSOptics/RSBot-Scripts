...
public class VarrockWest extends AbstractStrategy {

  public final Area BANK_AREA = new Area(new Tile[] {
			new Tile(3194, 3447, 0), new Tile(3178, 3432, 0) });

	public final Area MINE_AREA = new Area(new Tile[] {
			new Tile(3171, 3365, 0), new Tile(3183, 3381, 0) });

	public final Tile BANK_TILE = new Tile(3185, 3440, 0);
	public final Tile MINE_TILE = new Tile(3182, 3375, 0);
